  ...
  return (
    <React.Fragment>
        <div className='min-h-dvh'>
          ...
          <Input label='Email' labelWeight="bold" placeholder='email@mail.com' pattern="^[a-zA-Z0-9]+@[a-zA-Z0-9]+\.[A-Za-z]+$" onChange={()=>{}} type='email' name='email' required={true} disabled={false} color=''></Input>
          <Input label='Password' labelWeight="black" placeholder='Test' pattern="" onChange={()=>{}} type='password' name='test' required={true} disabled={false} color='primary'></Input>
          <Input label='Test' labelWeight="" placeholder='Test' pattern="" onChange={()=>{}} type='text' name='test' required={false} disabled={true} color='danger'></Input>
