...
export default function Profil() {
  const { user, setUser, handleLogout } = useAuth(); // Access setUser from AuthContext
      ...
      <div role="tablist" className="tabs tabs-bordered ">
        <a
          ...
          className={`tab text-black ${
            currentTab === "informations" && "tab-active"
          }`}
          onClick={() => {
        ...
        <a
          role="tab"
          className={`tab text-black ${
            currentTab === "factures" && "tab-active"
          }`}
          onClick={() => {
        ...
        <a
          role="tab"
          className={`tab text-black ${
            currentTab === "statistiques" && "tab-active"
          }`}
          onClick={() => {
            setCurrentTab("statistiques");
          }}
        >
          Statistiques
        </a>
