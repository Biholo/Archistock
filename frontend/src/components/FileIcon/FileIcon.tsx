import { File, FilePng, FileJpg, FileTxt, FilePdf, FileZip, FileDoc, FileXls, FileSvg, MicrosoftWordLogo, Gif, FileVideo, FileIni, FileMd, FileSql, FileJs, FileJsx, FileTs, FileTsx, FileHtml, FileCss, FileCSharp, FilePy, FileVue, FileText } from '@phosphor-icons/react';
